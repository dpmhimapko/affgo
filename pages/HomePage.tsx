...
export const HomePage: React.FC = () => {
    ...
    return (
        <div className="w-full space-y-10 pb-20">
            ...
            <div className="bg-white dark:bg-gray-900/50 p-8 md:p-12 rounded-[3rem] border-4 border-cartoon-dark shadow-cartoon-lg flex flex-col items-center">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white tracking-tighter italic uppercase text-center">WASSUP, CREATOR! 🔥</h2>
                <p className="text-slate-500 dark:text-slate-400 mt-2 text-base md:text-lg font-bold text-center">Dikit lagi kita gaskeun karyamu jadi makin goks!</p>

                <div className="mt-12 w-full max-w-2xl bg-slate-50 dark:bg-white/5 p-8 rounded-[2.5rem] border-4 border-cartoon-dark shadow-cartoon">
                    <h3 className="font-black text-slate-800 dark:text-white mb-6 text-xs uppercase tracking-[0.2em] italic text-center sm:text-left">
                        ATURAN MAIN KITA:
                    </h3>
                    <ul className="space-y-6">
                        ...
                        <li className="flex items-start gap-4 text-sm md:text-base text-red-600 dark:text-red-400 font-black uppercase italic bg-red-50 dark:bg-red-900/20 p-4 rounded-2xl border-2 border-red-600 shadow-cartoon">
                            <div className="mt-1.5 w-4 h-4 bg-red-600 rounded-full flex-shrink-0 shadow-[0_0_12px_rgba(220,38,38,0.8)] animate-pulse"></div>
