    ...
    const menuGroups = [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'goSetupV2', label: t('sidebar.goSetupV2'), icon: <Monitor /> },
          { id: 'goSetupV3', label: t('sidebar.goSetupV3'), icon: <Monitor /> },
          ...
          { id: 'goKamarAesthetic', label: t('sidebar.goKamarAesthetic'), icon: <SparklesIcon /> },
          { id: 'goSofa', label: t('sidebar.goSofa'), icon: <SparklesIcon /> },
          { id: 'goSofaV2', label: t('sidebar.goSofaV2'), icon: <SparklesIcon /> },
          { id: 'goHanger', label: t('sidebar.goHanger'), icon: <SparklesIcon /> },
          { id: 'goHangerV2', label: t('sidebar.goHangerV2'), icon: <SparklesIcon /> },
          { id: 'goKain', label: t('sidebar.goKain'), icon: <SparklesIcon /> },
          { id: 'goSepatu', label: t('sidebar.goSepatu'), icon: <SparklesIcon /> },
          { id: 'goSepatuV2', label: t('sidebar.goSepatuV2'), icon: <SparklesIcon /> },
